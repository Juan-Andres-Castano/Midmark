...
class Camera:
    def __init__(self, cam_num):
        ...
        self.frame = None  #np.zeros((1,1,1))  #np.zeros((1,1,1))
    ...
    def get_frame(self):
       ...
       # self.last_frame = cv2.cvtColor(self.last_frame,cv2.COLOR_BAYER_BG2RGB)    
        return self.last_frame
    
    def get_myframe(self):
        ret2, frame = self.cap.read()        
        return frame 
